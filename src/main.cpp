...
{
    int64 nSubsidy = 33.7 * COIN;
    
	if(nHeight < 2)
	{nSubsidy = 37000000 * COIN;}
	else
    if(nHeight < 50000)   
    {
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x99e09c6777825ac9aa29ab8ea04e0407b40c2509ebbd2f5964a28b4894eab7b8");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis Block:
        //block.nTime = 1388973600
        //block.nNonce = 102928
        //block.GetHash = 3162f0d2327e82b1f68a66258357bde7618a6a6ac68b7bd898a44fd4a19e34b6
        //CBlock(hash=3162f0d2327e82b1f68a, PoW=0000010f8dd9e3fd7b40, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=fc613890ee, nTime=1388973600, nBits=1e0ffff0, nNonce=102928, vtx=1)
        //  CTransaction(hash=fc613890ee, ver=1, vin.size=1, vout.size=1, nLockTime=0)
        //      CTxIn(COutPoint(0000000000, -1), coinbase 04ffff001d0104414a616e203674682c20323031342c2030323a303020612e6d2e20474d543a20426974636f696e2061626f757420746f206869742031206d696c6c696f6e20555344)
        //          CTxOut(nValue=88.00000000, scriptPubKey=040184710fa689ad5023690c80f3a4)
        //            vMerkleTree: fc613890ee


        // Genesis block
        const char* pszTimestamp = "Jan 6th, 2014, 02:00 a.m. GMT: Bitcoin about to hit 1 million USD";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        //block.nTime    = 1388204005;
        block.nTime    = 1388973600;
        block.nBits    = 0x1e0ffff0;
        //block.nNonce   = 12172472;
        block.nNonce   = 102928;

        if (fTestNet)
        {
            block.nTime    = 1388204004;
            block.nNonce   = 109203077;
        }

        //// debug print
        printf("block.GetHash() = %s\n", block.GetHash().ToString().c_str());
        printf("hashGenesisBlock(Defined) = %s\n", hashGenesisBlock.ToString().c_str());
        printf("block.hashMerkleRoot = %s\n", block.hashMerkleRoot.ToString().c_str());
        //assert(block.hashMerkleRoot == uint256("0xd8be6edae10dfe5dd73d1e20070caefb7e0256646b592afa5bca7e674dd33aca"));
        assert(block.hashMerkleRoot == uint256("0xfc613890ee269c342cb3b1d306baafac2021946fb428abead609fbb2e140c740"));
